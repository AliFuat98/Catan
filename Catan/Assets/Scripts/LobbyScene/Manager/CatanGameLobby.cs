...
public class CatanGameLobby : MonoBehaviour {
  private const string KEY_RELAY_JOIN_CODE = "relayJoinCode";
  public static CatanGameLobby Instance { get; private set; }
  ...
  private async Task<Allocation> AllocateRelay() {
    try {
      Allocation allocation = await RelayService.Instance.CreateAllocationAsync(CatanGameMultiplayer.MAX_PLAYER_AMOUNT - 1);
  ...
  public async void CreateLobby(string lobbyName, bool isPrivate) {
    ...
    try {
      joinedLobby = await LobbyService.Instance.CreateLobbyAsync(lobbyName, CatanGameMultiplayer.MAX_PLAYER_AMOUNT,
      ...
      CatanGameMultiplayer.Instance.StartHost();
  ...
  public async void QuickJoin() {
    ...
    try {
      ...
      CatanGameMultiplayer.Instance.StartClient();
    } catch (LobbyServiceException e) {
      Debug.Log(e);
